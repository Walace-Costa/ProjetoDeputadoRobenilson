...
const mencoes = [
  ...
  { veiculo:'Blog do Val Cabral', data:'Jul 2026', titulo:'Robenilson Torres pretende ser a voz de propostas, não de oportunismo', resumo:'Uma análise que separa quem tem projeto de quem só surfa a política. Assinada pelo jornalista Val Cabral — uma das vozes mais críticas e independentes da região, reconhecido por não medir palavras — a matéria avalia com propriedade a candidatura de Robenilson Torres, destacando um trabalho pautado por propostas concretas em meio a um cenário de oportunismo político.', url:'https://valcabral.blogspot.com/2026/07/robenilson-torres-pretende-ser-voz.html', img:'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjRMt8f54alhrtMlvpq28uxqUq0jTeKDLuaUU1cYAm0_aoBgKOS31dKgJ8MO1pLvuZFl5kUmfihnHrXxP1PLkIadc1lYwGKY_cL4R4IiD68P3JfXFYCYLA6aiaUkaNf6FPnYRDdoJR6m7xFcvdANaZGLYhAT3xmfulcRg5mx9_kvaqv8IblOiMtNITyx5s/s460/674419295_18345527287214170_2324922796629237550_n.jpg', tag:'Candidatura', tagColor:'#176939' },
];
