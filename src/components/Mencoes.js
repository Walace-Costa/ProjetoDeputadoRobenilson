...
const mencoes = [
  ...
  { veiculo:'Camacan BA Gov', data:'2024', titulo:'Referência em formação e proteção social — capacitação em 100+ municípios da Bahia', resumo:'Robenilson Torres foi o especialista convidado para conduzir a formação dos novos conselheiros tutelares do estado em mais de 100 municípios baianos.', url:'https://camacan.ba.gov.br/37081-camaca-futuros-conselheiros-tutelares-recebem-treinamento-e-capacitacao', img:'https://camacan.ba.gov.br/wp-content/uploads/materias/%7BCCAAD35D-EDED-E13B-4ADB-EBB0C2ECDBEA%7D.jpeg', tag:'Capacitação', tagColor:'#F5A623' },
  { veiculo:'Camaçari Gov', data:'2025', titulo:'Camaçari vai sediar XVIII Seminário da ACTEBA', resumo:'A ACTEBA, presidida por Robenilson Torres, leva seu seminário estadual a Camaçari, reunindo conselheiros tutelares de toda a Bahia.', url:'https://www.camacari.ba.gov.br/camacari-vai-sediar-xviii-seminario-da-acteba/', img:'https://www.camacari.ba.gov.br/wp-content/uploads/2024/02/sedes-camacari-vai-sediar-xviii-seminario-ateba-tiago-pacheco-22.2.24---5-1024x683.jpg', tag:'Seminário', tagColor:'#10B959' },
  { veiculo:'Cacau News', data:'2025', titulo:'Robenilson Torres em destaque na defesa dos direitos da criança no sul da Bahia', resumo:'Advogado e presidente da ACTEBA é reconhecido como referência regional na proteção integral da infância e adolescência no sul baiano.', url:'https://cacaunews.com/?p=6876', img:null, tag:'Sul da Bahia', tagColor:'#E63B2E' },
];
...
export default function Mencoes() {
  ...
  return (
    <section id="mencoes" ref={ref} style={{
      background:'linear-gradient(160deg,#021a0e 0%,#041f11 50%,#031508 100%)',
      padding:'90px 0', position:'relative', overflow:'hidden',
      borderTop:'1px solid rgba(16,185,89,0.2)',
      borderBottom:'1px solid rgba(16,185,89,0.15)',
    }}>
      {/* Orbes verdes */}
      <div style={{ position:'absolute', top:'-20%', right:'-10%', width:600, height:600, borderRadius:'50%', background:'radial-gradient(circle,rgba(16,185,89,0.07) 0%,transparent 65%)', pointerEvents:'none' }} />
      <div style={{ position:'absolute', bottom:'-15%', left:'-8%', width:500, height:500, borderRadius:'50%', background:'radial-gradient(circle,rgba(5,150,105,0.05) 0%,transparent 65%)', pointerEvents:'none' }} />
      <div style={{ position:'absolute', inset:0, backgroundImage:'linear-gradient(rgba(16,185,89,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(16,185,89,0.025) 1px,transparent 1px)', backgroundSize:'50px 50px', pointerEvents:'none' }} />

      <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 clamp(1rem,4vw,3rem)', position:'relative', zIndex:1 }}>
        <motion.div initial={{ opacity:0, y:30 }} animate={inView?{opacity:1,y:0}:{}}
          style={{ textAlign:'center', marginBottom:52 }}>
          <div style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(16,185,89,0.1)', border:'1px solid rgba(16,185,89,0.3)', borderRadius:999, padding:'5px 14px', marginBottom:20 }}>
            <div style={{ width:7, height:7, borderRadius:'50%', background:'#10B959', animation:'pulseGreen 2s infinite' }} />
            <span style={{ color:'#10B959', fontSize:11, fontWeight:600, letterSpacing:'0.12em', textTransform:'uppercase' }}>Na imprensa & menções</span>
          </div>
      ...
      <style>{`@keyframes pulseGreen{0%,100%{box-shadow:0 0 0 0 rgba(16,185,89,0.35)}50%{box-shadow:0 0 0 9px rgba(16,185,89,0)}}`}</style>
    </section>
  );
}
