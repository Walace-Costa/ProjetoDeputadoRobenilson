...
function InfiniteRow({ items, toLeft = false, speed = 40 }) {
  ...
  return (
    <div style={{ overflow:'hidden', position:'relative' }}>
      <div style={{ position:'absolute', left:0, top:0, bottom:0, width:edgeW, background:'linear-gradient(90deg,#14472E,transparent)', zIndex:2, pointerEvents:'none' }} />
      <div style={{ position:'absolute', right:0, top:0, bottom:0, width:edgeW, background:'linear-gradient(-90deg,#14472E,transparent)', zIndex:2, pointerEvents:'none' }} />
      <motion.div
