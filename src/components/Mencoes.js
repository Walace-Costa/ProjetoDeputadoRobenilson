  ...
  return (
    <a href={m.url} target="_blank" rel="noopener noreferrer"
      ...
      <motion.div whileHover={{ y:-6, borderColor:m.tagColor, boxShadow:`0 12px 40px ${m.tagColor}30` }}
        style={{ background:'#ffffff', border:'1px solid rgba(15,27,76,0.08)', borderRadius:14, overflow:'hidden', boxShadow:'0 2px 10px rgba(16,10,98,0.05)', transition:'border-color 0.25s, box-shadow 0.25s', height:'100%', cursor:'pointer', position:'relative' }}>
        ...
        <div style={{ padding:'14px 16px 18px' }}>
          ...
          <p style={{ color:'#4A4A4A', fontSize:11, lineHeight:1.6, marginBottom:12 }}>{m.resumo}</p>
