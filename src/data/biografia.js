...
export const topicos = [
  {
    ...
    resumo: [
      'Nascido e criado no Bairro Santa Inês, em Itabuna, Robenilson é filho da Professora Robélia e enfrentou de perto os desafios da periferia. Encontrou na fé cristã, como líder de jovens da Igreja Presbiteriana do Brasil, a base que despertou sua paixão pela infância e pela justiça social. Hoje é advogado (OAB/BA 59903), especialista em Proteção Integral de Crianças e Adolescentes, casado e pai de três filhos.',
    ],
    completo: [
  ...
  },
  {
    ...
    resumo: [
      "Aos 14 anos, liderou o movimento estudantil que conquistou o primeiro colégio de ensino médio do bairro Califórnia, onde depois lecionou por 18 anos. Criou o Projeto Encen'art, unindo arte e cidadania, e atuou como educador social no Projeto Vivart, da FICC.",
    ],
    completo: [
  ...
  },
  {
    ...
    resumo: [
      'Atuou no combate à pobreza em Itabuna (2021–2022), gerindo CadÚnico, Bolsa Família e programas habitacionais, e foi Ouvidor-Geral do município (2022–2025). Também foi assessor técnico ambiental no INEMA e, já em 2012, deu os primeiros passos na política como candidato a vereador.',
    ],
    completo: [
  ...
  },
  {
    ...
    resumo: [
      'Foi Conselheiro Tutelar e coordenador do Conselho Tutelar de Itabuna (2015–2018), além de presidente da Comissão dos Direitos da Criança e do Adolescente na OAB Itabuna. Hoje preside a ACTEBA, unificando a rede de proteção à infância e adolescência em toda a Bahia.',
    ],
    completo: [
...
// Versão integral, em 7 blocos separados, usada na página de Biografia completa.
export const topicosCompletos = [
  {
    id: 'origens', emoji: '🏡',
    titulo: 'Origens, Família e a Missão de uma Vida',
    completo: [
  ...
  {
    id: 'primeira-politica', emoji: '🗳️',
    titulo: 'A Primeira Incursão na Política Institucional',
    completo: [
      'Ainda antes de assumir cargos na gestão pública, Robenilson já havia dado seus primeiros passos na política formal. Em 2012, foi candidato a vereador em Itabuna pelo PSB, partido no qual atuou como dirigente municipal e advogado eleitoral — uma experiência que aproximou ainda mais sua trajetória de educador e militante social do universo da representação política institucional.',
    ],
  },
  {
    id: 'gestao-publica', emoji: '🏛️',
    titulo: 'Experiência e Gestão Pública: Testado na Prática',
    completo: [
      'Robenilson construiu uma carreira administrativa robusta. No combate à pobreza (2021–2022), atuou como Diretor do Departamento de Combate à Pobreza da Secretaria de Promoção Social de Itabuna, gestor do CadÚnico, Bolsa Família, Programas Habitacionais e PAA/Leite.',
      'Na defesa do cidadão (2022–2025), exerceu o cargo de Ouvidor-Geral do Município de Itabuna. Na gestão ambiental (2019–2020), atuou como Assessor Técnico no INEMA, representando o governo no Comitê de Bacias do Rio Cachoeira e na APA da Lagoa Encantada e Rio Almada.',
    ],
  },
  {
    id: 'infancia', emoji: '🛡️',
